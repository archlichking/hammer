...
func (c *GreeClient) signature(key string, method string, urlStr string, body string, timestamp string) string {
...
*/
func (c *GreeClient) SignS2SRequest(method string, url string, body string) (string, string, error) {
	if c.S2S_Secret == "" {
...
func (c *GreeClient) SignC2SRequest(method string, url string, body string) (string, string, error) {
	if c.S2S_Secret == "" {
		// no S2S sercret, return error
